                                        ...
                                        <div className="relative group cursor-pointer">
                                            ...
                                            <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                <div className="flex items-center justify-center gap-4 h-full">
                                                    <Link to='/forms' state={{ section: 'volunteer', eventName: sponsor.Eventname }}><button className="text-[#E91E31] hover:bg-[#E91E31] hover:text-white duration-200 bg-white px-4 py-2 concert-one-regular rounded">Volunteer</button></Link>
